...
python data_preprocessing.py --dataset fake    # For fake data only

# Step 3: Run topic analysis
echo "Step 2/3: Running topic analysis..."
python topic_analysis.py --input preprocessed_data/fake_processed.csv --output topic_analysis_results --lda-topics 15 --bert-min-size 10 --time-bin week
